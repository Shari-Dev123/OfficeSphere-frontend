...
export const clientAPI = {
  ...
  // Reports
  getProjectReports: (projectId, params) => api.get(`/reports/client/projects/${projectId}`, { params }),
  getWeeklyReport: (projectId, params) => api.get(`/reports/client/projects/${projectId}/weekly`, { params }),
  downloadReport: (reportId) => api.get(`/reports/client/${reportId}/download`, { responseType: "blob" }),

  // Feedback
  submitFeedback: (projectId, data) => api.post(`/client/projects/${projectId}/feedback`, data),
  getFeedbackHistory: (projectId) => api.get(`/client/projects/${projectId}/feedback`),
