...
export const adminAPI = {
  ...
  markNotificationAsUnread: (id) =>
    api.patch(`/admin/notifications/${id}/unread`),
  ...
  getMonthlyAttendance: (params) =>
    api.get("/attendance/admin/monthly", { params }),
  ...
  getEmployeeAttendance: (employeeId, params) =>
    api.get(`/attendance/admin/employee/${employeeId}`, { params }),
  approveCorrection: (id, data) =>
    api.put(`/attendance/admin/correction/${id}/approve`, data),
  rejectCorrection: (id, data) =>
    api.put(`/attendance/admin/correction/${id}/reject`, data),
  ...
  getPerformanceReport: (params) =>
    api.get("/reports/admin/performance", { params }),
  getProductivityReport: (params) =>
    api.get("/reports/admin/productivity", { params }),
...
export const employeeAPI = {
  ...
  checkOut: (data) =>
    api.post("/attendance/employee/attendance/checkout", data),
  ...
  getAttendanceSummary: (params) =>
    api.get("/attendance/employee/summary", { params }),
  requestCorrection: (data) =>
    api.post("/attendance/employee/correction", data),
  ...
  updateMeetingStatus: (id, status) =>
    api.patch(`/meetings/employee/${id}/status`, { status }),
...
export const clientAPI = {
  ...
  updateProject: (id, projectData) =>
    api.put(`/client/projects/${id}`, projectData),
  deleteProject: (id) => api.delete(`/client/projects/${id}`),
  sendProjectToAdmin: (requestData) =>
    api.post("/client/projects/send-to-admin", requestData),
  ...
  updateMeetingStatus: (id, status) =>
    api.patch(`/meetings/client/${id}/status`, { status }),
